const images = [
    ...
    {
        src: '/src/scans%20edited/1transportation/passfukuoka.png',
        fullSrc: '/src/scans/1transportation/passfukuoka.png',
        title: 'Hayakaken (はやかけん)',
        description: `Hayakaken (はやかけん) transit card.
        Used to get around Fukuoka (福岡市) public transport.`
    },
    {
        src: '/src/scans%20edited/1transportation/passincheon.png',
        fullSrc: '/src/scans/1transportation/passincheon.png',
    ...
    {
        src: '/src/scans%20edited/2food/blackcoffee4929.png',
        fullSrc: '/src/scans/2food/blackcoffee4929.png',
        title: 'Hot Coffee',
    ...
    {
        src: '/src/scans%20edited/2food/botm_sydney.png',
        fullSrc: '/src/scans/2food/botm_sydney.png',
        title: 'BOTM - Sydney',
        description: `August Bird of the Month.
        Thanks for the eggs, Syd!`
    },
    {
        src: '/src/scans%20edited/2food/mcdonaldhoneymustard.png',
        fullSrc: '/src/scans/2food/mcdonaldhoneymustard.png',
        title: 'Tendie Sauce',
        description: `McDonald's Honey Mustard Lid.
        The only "good" sauce.`
    },
    {
        src: '/src/scans%20edited/2food/mcdonaldlandnuggets.png',
        fullSrc: '/src/scans/2food/mcdonaldlandnuggets.png',
        title: 'Unappetizing Characters',
        description: `McDonaldland 10 pc Nugget Box Top.
        I think the faces make these unappealing to eat. I gotta stop eating these.`
    },
    {
        src: '/src/scans%20edited/2food/mcdouble00.png',
        fullSrc: '/src/scans/2food/mcdouble00.png',
        title: 'McDouble Order Number 00',
        description: `Ticket from an August, 2025 drive-thru order.
        Just hit the rollover. I scanned this forever ago and forgot the date.`
    },
    {
    ...
    {
        src: '/src/scans%20edited/2food/mcdouble23e.png',
        fullSrc: '/src/scans/2food/mcdouble23.png',
        title: 'McDouble Order Number 23',
        description: `Ticket from a July? August? drive-thru order.
        Again, this has been sitting for a while. I leaned into the McDoubles a bit.`
    },
    {
    ...
    {
        src: '/src/scans%20edited/2food/mcdouble92.png',
        fullSrc: '/src/scans/2food/mcdouble92.png',
        title: 'McDouble Order Number 92',
        description: `Ticket from a July-ish, 2025 drive-thru order.
        I found out I have celiac disease so I think this is it!`
    },
    {
        src: '/src/scans%20edited/2food/occlupanid1632.png',
        fullSrc: '/src/scans/2food/occlupanid1632.png',
        title: 'Occlupanid 1632',
        description: `Bagel Clip.
        I'm not going to go through and ID these myself. Will probably not collect a ton.`
    },
    {
        src: '/src/scans%20edited/2food/occlupanid15169.png',
        fullSrc: '/src/scans/2food/occlupanid15169.png',
        title: 'Occlupanid 15169',
        description: `Sourdough Clip.
        The variance in these is insane.`
    },
    {
        src: '/src/scans%20edited/2food/wraplittledebbieapplefruitpie.png',
        fullSrc: '/src/scans/2food/wraplittledebbieapplefruitpie.png',
        title: 'Square Snack',
    ...
    {
        src: '/src/scans%20edited/3entry/cudalailama.png',
        fullSrc: '/src/scans/3entry/cudalailama.png',
    ...
    {
        src: '/src/scans%20edited/3entry/custateofsatire.png',
        fullSrc: '/src/scans/3entry/custateofsatire.png',
    ...
    {
        src: '/src/scans%20edited/3entry/cuwoz.png',
        fullSrc: '/src/scans/3entry/cuwoz.png',
        title: 'The Woz',
    ...
    {
        src: '/src/scans%20edited/3entry/kennedyspacecenter.png',
        fullSrc: '/src/scans/3entry/kennedyspacecenter.png',
    ...
    {
        src: '/src/scans%20edited/4games/lotto0000.png',
        fullSrc: '/src/scans/4games/lotto0000.png',
        title: 'Void Not For Sale',
        description: `A fun *VOID* ticket I got.
        Obvious loser.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0628.png',
        fullSrc: '/src/scans/4games/lotto0628.png',
        title: 'Lotto Jun 28',
        description: `Powerball ticket Jun 28.
        02 16 33 56 57 01. Loser.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0707.png',
        fullSrc: '/src/scans/4games/lotto0707.png',
        title: 'Lotto Jul 7',
        description: `Powerball ticket Jul 7.
        06 08 24 53 58 24. One of these is a $2 win but I forget. I scanned these over the summer and just haven't updated.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0719.png',
        fullSrc: '/src/scans/4games/lotto0719.png',
        title: 'Lotto Jul 19',
        description: `Powerball ticket Jul 19.
        17 44 52 55 63 20. Probable loser.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0721.png',
        fullSrc: '/src/scans/4games/lotto0721.png',
        title: 'Lotto Jul 21',
        description: `Powerball ticket Jul 21.
        02 19 22 47 66 14. Probable loser.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0728.png',
        fullSrc: '/src/scans/4games/lotto0728.png',
        title: 'Lotto Jul 28',
        description: `Powerball ticket Jul 28.
        19 21 34 61 67 05. Probable loser.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0802.png',
        fullSrc: '/src/scans/4games/lotto0802.png',
        description: `Powerball ticket Aug 2.
        06 24 37 63 67 17. Probable loser.`
    },
    {
        src: '/src/scans%20edited/4games/lotto0811.png',
        fullSrc: '/src/scans/4games/lotto0811.png',
        description: `Powerball ticket Aug 11.
        24 25 46 58 61 08. Probable loser.`
    },
    {
    ...
    {
        src: '/src/scans%20edited/5reference/calsummer.png',
        fullSrc: '/src/scans/5reference/calsummer.png',
        title: '暑中お見舞い申し上げます',
    ...
    {
        src: '/src/scans%20edited/5reference/hpcertofcalibration.png',
        fullSrc: '/src/scans/5reference/hpcertofcalibration.png',
        title: 'HP Certificate of Calibration',
        description: `Certificate of Calibration.
        Power supply calibration cert from 1998.`
    },
    {
        src: '/src/scans%20edited/5reference/protractor.png',
        fullSrc: '/src/scans/5reference/protractor.png',
        title: 'Mother Protractor',
        description: `Acute (heh) Mother protractor.`
    },
    {
        src: '/src/scans%20edited/5reference/ulinefoodcontainers.png',
        fullSrc: '/src/scans/5reference/ulinefoodcontainers.png',
        title: 'Food Containers',
        description: `Uline food containers.
        I get these massive order books a few times a year.`
    },
    {
        src: '/src/scans%20edited/5reference/ulinegriddle.png',
        fullSrc: '/src/scans/5reference/ulinegriddle.png',
        title: 'Griddle Me This',
        description: `Uline griddle free offer.
        I love the stupid pun.`
    },
    {
        src: '/src/scans%20edited/5reference/ulinewoodcrates.png',
        fullSrc: '/src/scans/5reference/ulinewoodcrates.png',
        title: 'Uline wood crates',
        description: `I wonder who chooses these "models".`
    },
    {
        src: '/src/scans%20edited/5reference/ulinewoodcrateslarge.png',
        fullSrc: '/src/scans/5reference/ulinewoodcrateslarge.png',
    ...
    {
        src: '/src/scans%20edited/6trading_cards/dabcyborg.png',
        fullSrc: '/src/scans/6trading_cards/dabcyborg.png',
        title: 'Cyborg',
        description: `Cyborg (Victor Stone) trading card from Dave & Busters.
        Another random coin-dropper prize.`
    },
    {
        src: '/src/scans%20edited/6trading_cards/dabspock.png',
        fullSrc: '/src/scans/6trading_cards/dabspock.png',
        title: 'Bones',
        description: `Dr. Leonard H. McCoy ("Bones") trading card from Dave & Busters.
                    No full sets from my last visit.`
    },
    {
        src: '/src/scans%20edited/6trading_cards/desertstormcard.png',
        fullSrc: '/src/scans/6trading_cards/desertstormcard.png',
    ...
    {
        src: '/src/scans%20edited/6trading_cards/desertstormcardapache.png',
        fullSrc: '/src/scans/6trading_cards/desertstormcardapache.png',
    ...
    {
        src: '/src/scans%20edited/6trading_cards/desertstormcardapc.png',
        fullSrc: '/src/scans/6trading_cards/desertstormcardapc.png',
        title: 'Marine APCs',
    ...
    {
        src: '/src/scans%20edited/6trading_cards/desertstormmlrs.png',
        fullSrc: '/src/scans/6trading_cards/desertstormmlrs.png',
        title: 'MLRS',
    ...
    {
        src: '/src/scans%20edited/6trading_cards/desertstormtopgun.png',
        fullSrc: '/src/scans/6trading_cards/desertstormtopgun.png',
        title: 'Top Gun',
        description: `Top Gun card from the Topps Desert Storm trading card pack.
        [Comment removed by Tom Cruise's agent, Maha Dakhil].`
    },
    {
        src: '/src/scans%20edited/6trading_cards/desertstormwhatatank.png',
        fullSrc: '/src/scans/6trading_cards/desertstormwhatatank.png',
    ...
    {
        src: '/src/scans%20edited/6trading_cards/pokemondragonite.png',
        fullSrc: '/src/scans/6trading_cards/pokemondragonite.png',
    ...
    {
        src: '/src/scans%20edited/7textures/pjwrap.png',
        fullSrc: '/src/scans/7textures/pjwrap.png',
        title: 'Cozy',
        description: `"Fancy" PJ Wrapping Paper.
        The only thing that made the delivery packaging nice.`
    },
    {
        src: '/src/scans%20edited/7textures/postcardfromrob.png',
        fullSrc: '/src/scans/7textures/postcardfromrob.png',
    ...
    {
        src: '/src/scans%20edited/8literature/dbzopcrossepoch.png',
        fullSrc: '/src/scans/8literature/dbzopcrossepoch.png',
    ...
    {
        src: '/src/scans%20edited/8literature/dszenitsu.png',
        fullSrc: '/src/scans/8literature/dszenitsu.png',
    ...
    {
        src: '/src/scans%20edited/8literature/sidec1982.png',
        fullSrc: '/src/scans/8literature/sidec1982.png',
    ...
    {
        src: '/src/scans%20edited/9misc/applecard.png',
        fullSrc: '/src/scans/9misc/applecard.png',
        title: 'Gen 1 Titanium Apple Card',
        description: `I like the weight. 
        Titanium.`
    },
    {
        src: '/src/scans%20edited/9misc/guitarpick.png',
        fullSrc: '/src/scans/9misc/guitarpick.png',
        title: 'Self Explanatory',
        description: `Cool guy guitar pick.
        Useful regardless of my guitar skills.`
    },
    {
        src: '/src/scans%20edited/9misc/selfportpen.png',
        fullSrc: '/src/scans/9misc/selfportpen.png',
        title: 'Self Portrait',
        description: `Pen on Notebook Paper.
        Quick doodle from a philosophy class I believe.`
    },
    {
        src: '/src/scans%20edited/9misc/selfportraitlitho.png',
        fullSrc: '/src/scans/9misc/selfportraitlitho.png',
        title: 'Self Portrait',
        description: `Lithograph.
        I took 'Intro To Screenprinting' in college and was able to produce such masterpieces as this.`
    },
    {
        src: '/src/scans%20edited/9misc/selfportraitstickynote.png',
        fullSrc: '/src/scans/9misc/selfportraitstickynote.png',
